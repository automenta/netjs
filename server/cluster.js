...
var figue = function () {
    ...
    function fcmeans (k, vectors, epsilon, fuzziness, distFunc) {
            ...
            while (repeat) {
                    ...
                    for (i = 0 ; i < membershipMatrix.rows ; i++) {
                            for (j = 0 ; j < k ; j++) {
                                    ...
                                    for (l = 0 ; l < k ; l++) {
                                            if (distFunc(vectors[i] , centroids[l]) === 0)
                                                    tmp = 0 ;
                                            else
                                                    tmp =  distFunc(vectors[i] , centroids[j]) / distFunc(vectors[i] , centroids[l]) ;
